...
<Frame caption="Sidebar">
  <img height="100" src="/images/ClientStatementSidebar.png" />
</Frame>

Select the client and date range to generate the client statement form.&#x20;

![](images/ClientStatementForm.png)