...
```mermaid
flowchart LR
    A(Complete Client Information Form)
    A --> B(Check Supporting Documents)
    B --> C(Perform Screening)
    C --> D(Perform Investment / Risk / Professional Investor / AML Assessments)
```
